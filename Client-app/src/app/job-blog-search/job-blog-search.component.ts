...
@Component({
  selector: 'app-job-blog-search',
  templateUrl: './job-blog-search.component.html',
  styleUrls: ['./job-blog-search.component.css']
})
export class JobBlogSearchComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.activateroute.paramMap.subscribe(params=>{
      ...
      let title = this.searchString + ' | Search Results | Latest Jobs | Workire'
      ...
      let keywords = "Search,Latest Jobs,Blog," + this.searchString
      let type = 'article'
      ...
      this.loc.searchJobBlog(this.searchString).subscribe((res:any)=>{
        this.spinner.hide();
  ...
  searchChange()
  {
    this.route.navigate(['/latest-jobs','search',this.blogSearch.value])
  }
