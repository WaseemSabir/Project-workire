...
@Component({
  selector: 'app-job-one-company',
  templateUrl: './job-one-company.component.html',
  styleUrls: ['./job-one-company.component.css']
})
export class JobOneCompanyComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.activatedRoute.paramMap.subscribe(params => {
        ...
        this.meta.updateTag({name: "description",content:'Apply for the best jobs in ' + c + '.New careers in ' + c + ' are added daily on Workire.com. Apply quickly to various ' + c + ' job openings that are hiring near you.'})
        this.meta.updateTag({name: 'keywords', content:'Jobs in '+ c + ', Job in ' + c +",Career in "+ c + c +" job,Job opportunity in "+c+",Employment in " + c+",Recruitment in "+ c +",Jobs openings in "+c+",Jobs search in "+c})
        ...
        this.meta.updateTag({property: 'og:description',content:'Apply for the best jobs in ' + c + '.New careers in ' + c + ' are added daily on Workire.com. Apply quickly to various ' + c + ' job openings that are hiring near you.'})
        ...
        this.meta.updateTag({name: 'twitter:description',content:'Apply for the best jobs in ' + c + '.New careers in ' + c + ' are added daily on Workire.com. Apply quickly to various ' + c + ' job openings that are hiring near you.'})
